...
<body>
    ...
    <div class="row d-flex justify-content-center align-items-center father-card"
        ...
        <div
            ...
            <h3 class="w-100">Editar Produtoras</h3>
            ...
            <form class="form-inline col-10 my-lg-0" action="edit.php" method="post">
                ...
                <div class="form-group">
                    <div class="form-floating">
                        <input type="text" name="nome" id="floatingInput" value="<?php echo $produtoras['nome'] ?>"
                            class="form-control" placeholder="Fox">

                    </div>
                </div>
                <div class="form-group">
                    <div class="form-floating">
                    <input type="text" name="descrProdutora" id="floatingInput" class="form-control" placeholder="Descrição" value="<?php echo $produtoras['descrProdutora'] ?>">
                    </div>
                </div>
                <div class="form-group">
