...
$PDO = db_connect();
$sql = "SELECT F.nome,F.id, F.ano, F.paisOrigem, F.sinopse, F.img_link as link, P.nome as produtora_nome FROM filmes as F inner join produtoras as P on F.id_produtora = P.id";
